package com.sds.springbootmultithreading.controller;

import com.sds.springbootmultithreading.entity.User;
import com.sds.springbootmultithreading.service.UserService;
...
public class UserController {
    ...
    @GetMapping(value = "/users/executor", produces = "application/json")
    public List<User> findAllUsersByExecutor() {
        return service.findAllUsersByTaskExecutor();
    }
